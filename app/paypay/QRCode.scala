...
import jp.ne.paypay.model.{QRCode => OyaQRCode}
...
//   }
  override def toString() = {
    "QRCode{" + "merchantPaymentId='" + getMerchantPaymentId + '\'' +
      ", amount=" + getAmount +
      ...
      ", isAuthorization=" + isIsAuthorization +
      ", authorizationExpiry=" + getAuthorizationExpiry +
